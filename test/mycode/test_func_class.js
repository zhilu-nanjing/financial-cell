...
import * as database from '../../src/calc/expression_fn/lib/engineering'
...
describe('expression_fn integration', function () {
    describe('func', function () {
        ...
        it('CHISQTEST', function () {
            let res1 = easySolve(statistical.CHISQTEST, [[[58,35],[11,25],[10,23]],[[45.35,47.65],[17.56,18.44],[16.09,16.91]]])
            console.log(res1)
            assert(Math.abs(res1 - 0.000308192) < 0.000001)
            let res2 = easySolve(statistical.CHISQTEST, [[[58,11,35],[11,25],[10,23]],[[45.35,47.65],[17.56,18.44],[16.09,16.91]]])
            console.log(res2)
        ...
        it('CONFIDENCENORM', function () {
            let res1 = easySolve(statistical.CONFIDENCENORM, [0.05,2.5,50])
            console.log(res1)
            assert(Math.abs(res1 - 0.692951912) < 0.001)
        })
        it('CONFIDENCET', function () {
            let res1 = easySolve(statistical.CONFIDENCET, [0.05,1,50])
            console.log(res1)
        ...
        it('COVARIANCEP', function () {
            let res1 = easySolve(statistical.COVARIANCEP, [[3,2,4,5,6],[9,7,1.2,15,17]])
            console.log(res1)
            assert.equal(res1, 5.2)
        })
        it('COVARIANCES', function () {
            let res1 = easySolve(statistical.COVARIANCES, [[2,4,8],[5,11,12]])
            console.log(res1)
        ...
        //     let res1 = easySolve(database.DAVERAGE, [[['树种','高度','年数','产量',0],['苹果树',18,20,14,0],['梨树',12,12,10,0],['樱桃树',13,14,9,0],['苹果树',14,15,10,0],['梨树',9,8,8,0],['苹果树',8,9,6,0]],'产量',[['树种','高度',0,0,'高度'],['=苹果树','>10',0,0,'<16']]])
        //     console.log(res1)
