...
describe('expression_fn integration', function () {
    describe('func', function () {
        ...
        it('AVEDEV', function () {
            ...
            let res2 = easySolve(statistical.AVEDEV, [43, 22, 33, 12, 55, 44, 66])
            console.log(res2)
            assert(Math.abs(res2 - 14.5306) < 0.001)
        })
        it('ARABIC', function () {
        ...
        it('CEILING.MATH', function () {
            let res1 = easySolve(mathtrig.CEILING.MATH, [24.3, 5])
            console.log(res1)
            assert.equal(res1, 25)
            let res2 = easySolve(mathtrig.CEILING.MATH, [6.7])
            console.log(res2)
            assert.equal(res2, 7)
            let res3 = easySolve(mathtrig.CEILING.MATH, [-8.1, 2])
            console.log(res3)
            assert.equal(res3, -8)
            let res4 = easySolve(mathtrig.CEILING.MATH, [-5.5, 2, -1])
            console.log(res4)
            assert.equal(res4, -6)
        })
        it('CEILING.PRECISE', function () {
            let res1 = easySolve(mathtrig.CEILING.PRECISE, [24.3, 5])
            console.log(res1)
            assert.equal(res1, 25)
            let res2 = easySolve(mathtrig.CEILING.PRECISE, [6.7])
            console.log(res2)
            assert.equal(res2, 7)
            let res3 = easySolve(mathtrig.CEILING.PRECISE, [-8.1, 2])
            console.log(res3)
            assert.equal(res3, -8)
            let res4 = easySolve(mathtrig.CEILING.PRECISE, [-5.5, 2, -1])
            console.log(res4)
            assert.equal(res4, -6)
        })
        it('CHAR', function () {
        ...
        it('COUNTIF', function () {
            let res1 = easySolve(statistical.COUNTIF, [['苹果', '橙子', '桃子', '苹果'], '苹果'])
            console.log(res1)
            assert.equal(res1, 2)
        })
        ...
        it('DCOUNT', function () {
            let res1 = easySolve(database.DCOUNT, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '年数', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert.equal(res1, 2)
        })
        it('DCOUNTA', function () {
            let res1 = easySolve(database.DCOUNTA, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '产量', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert.equal(res1, 2)
        })
        it('DEC2BIN', function () {
        ...
        it('DELTA', function () {
            let res1 = easySolve(engineering.DELTA, [5, 4])
            console.log(res1)
            assert.equal(res1, 0)
            let res2 = easySolve(engineering.DELTA, [5, 5])
            console.log(res2)
            assert.equal(res2, 1)
            let res3 = easySolve(engineering.DELTA, [0.5, 0])
            console.log(res3)
            assert.equal(res3, 0)
            let res4 = easySolve(engineering.DELTA, ['a', 0])
            console.log(res4)
            assert.equal(res4.message, ERROR_VALUE)
        })
        it('DEVSQ', function () {
            let res1 = easySolve(statistical.DEVSQ, [4, 5, 8, 7, 11, 4, 3])
            console.log(res1)
            assert.equal(res1, 48)
        })
        it('DISC', function () {
            let res1 = easySolve(financial.DISC, ['2018/07/01', '2038/01/01', 97.975, 100, 1])
            console.log(res1)
            assert(Math.abs(res1 - 0.001038191) < 0.001)
            let res2 = easySolve(financial.DISC, ['2018/07/01', '2038/01/01', 97.975, 100, 0])
            console.log(res2)
            assert(Math.abs(res2 - 0.001038462) < 0.001)
            let res3 = easySolve(financial.DISC, ['2018/07/01', '2038/01/01', 97.975, 100, 2])
            console.log(res3)
            assert(Math.abs(res3 - 0.001023302) < 0.001)
            let res4 = easySolve(financial.DISC, ['2018/07/01', '2038/01/01', 97.975, 100, 3])
            console.log(res4)
            assert(Math.abs(res4 - 0.001037514) < 0.001)
            let res5 = easySolve(financial.DISC, ['2018/07/01', '2038/01/01', 97.975, 100, 4])
            console.log(res5)
            assert(Math.abs(res5 - 0.001038462) < 0.001)
        })
        it('DMAX', function () {
            let res1 = easySolve(database.DMAX, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '年数', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert.equal(res1, 20)
        })
        it('DMIN', function () {
            let res1 = easySolve(database.DMIN, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '年数', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert.equal(res1, 15)
        })
        it('DOLLAR', function () {
            let res1 = easySolve(text.DOLLAR, [1234.567, 2])
            console.log(res1)
            assert.equal(res1, '$1,234.57')
            let res2 = easySolve(text.DOLLAR, [-1234.567, 3])
            console.log(res2)
            assert.equal(res2, '($1,234.567)')
            let res3 = easySolve(text.DOLLAR, [-0.123, 4])
            console.log(res3)
            assert.equal(res3, '($0.1230)')
            let res4 = easySolve(text.DOLLAR, [99.888])
            console.log(res4)
            assert.equal(res4, '$99.89')
        })
        it('DOLLARDE', function () {
            let res1 = easySolve(financial.DOLLARDE, [1.02, 16])
            console.log(res1)
            assert.equal(res1, 1.125)
            let res2 = easySolve(financial.DOLLARDE, [1.1, 32])
            console.log(res2)
            assert.equal(res2, 1.3125)
            let res3 = easySolve(financial.DOLLARDE, [-1.02, -16])
            console.log(res3)
            assert.equal(res3.message, ERROR_NUM)
            let res4 = easySolve(financial.DOLLARDE, [0.55, 0.16])
            console.log(res4)
            assert.equal(res4.message, ERROR_DIV0)
        })
        it('DOLLARFR', function () {
            let res1 = easySolve(financial.DOLLARFR, [1.125, 16])
            console.log(res1)
            assert.equal(res1, 1.02)
            let res2 = easySolve(financial.DOLLARFR, [1.125, 32])
            console.log(res2)
            assert.equal(res2, 1.04)
            let res3 = easySolve(financial.DOLLARFR, [-1.02, -16])
            console.log(res3)
            assert.equal(res3.message, ERROR_NUM)
            let res4 = easySolve(financial.DOLLARFR, [0.55, 0.16])
            console.log(res4)
            assert.equal(res4.message, ERROR_DIV0)
        })
        it('DPRODUCT', function () {
            let res1 = easySolve(database.DPRODUCT, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '产量', [['树种', '高度'], ['=苹果树', '>15'], ['=梨树', new CellVEmpty()]]])
            console.log(res1)
            assert.equal(res1, 1120)
        })
        it('DSTDEV', function () {
            let res1 = easySolve(database.DSTDEV, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '产量', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert(Math.abs(res1 - 2.828427) < 0.001)
        })
        it('DSTDEVP', function () {
            let res1 = easySolve(database.DSTDEVP, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '产量', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert.equal(res1, 2)
        })
        it('DVAR', function () {
            let res1 = easySolve(database.DVAR, [[['树种', '高度', '年数', '产量'], ['苹果树', 18, 20, 14], ['梨树', 12, 12, 10], ['樱桃树', 13, 14, 9], ['苹果树', 14, 15, 10], ['梨树', 9, 8, 8], ['苹果树', 8, 9, 6]], '产量', [['树种', '高度'], ['=苹果树', '>10']]])
            console.log(res1)
            assert.equal(res1, 8)
        })
        it('DVARP', function () {
